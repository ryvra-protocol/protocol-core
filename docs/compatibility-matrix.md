...
| `ryvra-protocol/policy-risk` | `1.0.0` | `1.0.0` | `1.0.0-pr8` | PARTIAL (adapter-aligned here; downstream repo confirmation still required) |
| `ryvra-protocol/ledger-settlement` | `1.0.0` | `1.0.0` | `1.0.0-pr8` | PARTIAL (adapter-aligned here; downstream repo confirmation still required) |
| `ryvra-protocol/accounts` | `1.0.0` | `1.0.0` | `1.0.0-pr8` | PARTIAL (manual confirmation required in consumer repo CI) |
| `ryvra-protocol/asset-registry` | `1.0.0` | `1.0.0` | `1.0.0-pr8` | PARTIAL (manual confirmation required in consumer repo CI) |
| `ryvra-protocol/website` | `1.0.0` | `1.0.0` | `1.0.0-pr8` | PARTIAL (docs/API references must be validated in website pipeline) |
| `ryvra-protocol/docs` | `1.0.0` | `1.0.0` | `1.0.0-pr8` | PARTIAL (docs snapshot update required) |
